      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden sm:flex items-center space-x-2 sm:space-x-4">
            <button className="text-gray-800 hover:text-teal-600 px-3 sm:px-6 py-2 sm:py-3 rounded-xl text-sm sm:text-base font-bold transition-all duration-300 hover:bg-teal-50">
              Login
            </button>
            <button className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-xl text-sm sm:text-base font-bold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl">
              Get Started
            </button>
          </div>
  ...
  return (
    <section className="pt-20 sm:pt-32 pb-12 sm:pb-24 bg-gradient-to-br from-gray-50 via-white to-teal-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 sm:opacity-30">
        <div className="absolute top-10 sm:top-20 left-5 sm:left-10 w-32 sm:w-72 h-32 sm:h-72 bg-teal-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div className="absolute top-20 sm:top-40 right-5 sm:right-10 w-32 sm:w-72 h-32 sm:h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-10 sm:bottom-20 left-1/2 w-32 sm:w-72 h-32 sm:h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="inline-flex items-center bg-gradient-to-r from-gray-800 to-gray-900 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base lg:text-lg font-semibold mb-6 sm:mb-8 shadow-md hover:shadow-xl transition-shadow duration-300 animate-fade-in">
              <span className="animate-pulse">🌟</span>
              <span className="ml-2">Explore for more</span>
            </div>
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="bg-gradient-to-br from-teal-500 via-teal-600 to-teal-700 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-10 shadow-3xl transform hover:rotate-0 transition-transform duration-500 hover:scale-105">
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 shadow-xl">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center space-x-2 sm:space-x-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-pink-500 to-rose-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg">
                      <span className="text-lg sm:text-xl lg:text-2xl">✨</span>
                    </div>
                    <div>
                      <h3 className="text-sm sm:text-base lg:text-xl font-bold text-gray-900">Glamio Beauty Studio</h3>
                      <p className="text-xs sm:text-sm lg:text-base text-gray-500 font-medium">0.6 km away</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-1 sm:space-x-2 bg-yellow-50 px-2 sm:px-4 py-1 sm:py-2 rounded-full">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4">
                  <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-2 sm:p-4 rounded-lg sm:rounded-xl border border-pink-200">
                    <p className="text-xs sm:text-sm text-gray-500 font-medium">Hair Coloring</p>
                    <p className="text-sm sm:text-base lg:text-xl font-bold text-gray-900">₹2,500</p>
                  </div>
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-2 sm:p-4 rounded-lg sm:rounded-xl border border-purple-200">
                    <p className="text-xs sm:text-sm text-gray-500 font-medium">Booking at</p>
                    <p className="text-sm sm:text-base lg:text-xl font-bold text-gray-900">Today 3:00 PM</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-white/20 backdrop-blur-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white border border-white/30">
            ...
            {/* Floating elements */}
            <div className="absolute -top-3 -right-3 sm:-top-6 sm:-right-6 bg-white rounded-xl sm:rounded-2xl p-2 sm:p-4 shadow-2xl animate-bounce">
              <MessageCircle className="w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-teal-600" />
            </div>
            <div className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 bg-white rounded-xl sm:rounded-2xl p-2 sm:p-4 shadow-2xl animate-pulse">
              <MapPin className="w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-teal-600" />
            </div>
            <div className="absolute top-1/2 -right-4 sm:-right-8 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full p-2 sm:p-3 shadow-lg animate-spin">
