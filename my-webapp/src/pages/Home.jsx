...
const Welcome = () => {
  ...
  const offers = [
    { store: "Elegance Salon", discount: "50% OFF", service: "Hair Spa", time: "4h ago", likes: 25 },
    { store: "Tech Repair Hub", discount: "30% OFF", service: "Phone Repair", time: "2h ago", likes: 18 },
    { store: "Cafe Delight", discount: "Buy 1 Get 1", service: "Coffee & Snacks", time: "1h ago", likes: 42 },
    { store: "Fashion Store", discount: "40% OFF", service: "Summer Collection", time: "6h ago", likes: 33 }
  ];

  const features = [
    {
      icon: Target,
      title: "Local Offers in Reels",
      description: "See time-sensitive deals visually, swipe and book instantly"
    },
    {
      icon: Store,
      title: "Shop in 2 Mins",
      description: "Small vendors can start selling in just 3 simple steps"
    },
    {
      icon: Users,
      title: "For Buyers & Sellers",
      description: "Helps both ends of local commerce connect seamlessly"
    },
    {
      icon: Phone,
      title: "Direct Booking",
      description: "Skip middlemen, interact instantly with local businesses"
    },
    {
      icon: TrendingUp,
      title: "Sales Booster",
      description: "Promotes local economic activity digitally"
    }
  ];
  ...
  const explanationCards = [
    {
      icon: Store,
      title: "Find Local Stores & Offers",
      description: "Scroll through updated deals in your area"
    },
    {
      icon: Smartphone,
      title: "Shop Goes Digital",
      description: "Store owners can post, sell & chat with users"
    },
    {
      icon: Calendar,
      title: "Book Appointments",
      description: "Salons, tailors, mechanics, freelancers – all in one app"
    },
    {
      icon: MessageCircle,
      title: "Chat & Order",
      description: "Talk directly with vendors like WhatsApp"
    }
  ];
  ...
  const FlipCard = ({ feature, index }) => (
    ...
    >
      <div className={`absolute inset-0 w-full h-full transition-transform duration-700 preserve-3d ${flippedCard === index ? 'rotate-y-180' : ''}`}>
        {/* Front */}
        <div className="absolute inset-0 w-full h-full backface-hidden bg-white rounded-xl border-2 border-teal-100 p-6 flex flex-col items-center justify-center shadow-lg hover:shadow-xl transition-shadow">
        ...
        {/* Back */}
        <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-teal-600 rounded-xl p-6 flex items-center justify-center shadow-lg">
          <p className="text-white text-center text-sm leading-relaxed">{feature.description}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-teal-50">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Discover Real-Time
                  <span className="text-teal-600 block">Offers from Nearby Shops</span>
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Just like scrolling through stories — now you can shop smarter, book services, or buy from local stores digitally.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-teal-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-700 transform hover:scale-105 transition-all duration-300 flex items-center justify-center">
                  <MapPin className="w-5 h-5 mr-2" />
                  Explore Offers Nearby
                </button>
                <button className="border-2 border-teal-600 text-teal-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-600 hover:text-white transition-all duration-300">
                  Create Your Store
                </button>
              </div>
            </div>

            {/* Animated Offers Display */}
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-6 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-3">
                    <h3 className="font-semibold text-gray-900">{offers[currentOffer].store}</h3>
                    <p className="text-sm text-gray-500">{offers[currentOffer].time}</p>
                  </div>
                </div>
                
                <div className="bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl p-6 text-white text-center">
                  <div className="text-3xl font-bold mb-2">{offers[currentOffer].discount}</div>
                  <div className="text-lg mb-4">{offers[currentOffer].service}</div>
                  <button className="bg-white text-teal-600 px-6 py-2 rounded-full font-semibold hover:bg-gray-100 transition-colors">
                    Book Now
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="flex items-center text-gray-500">
                    ...
                    <span>{offers[currentOffer].likes} interested</span>
                  </div>
                  <div className="flex items-center text-gray-500">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">What is SerchBy?</h2>
            <p className="text-xl text-gray-600">Understand everything in 20 seconds</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {explanationCards.map((card, index) => (
              <div key={index} className="group">
                <div className="bg-gradient-to-br from-teal-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 border border-teal-100">
                  <div className="w-16 h-16 bg-teal-600 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-300">
      ...
      {/* Why SerchBy - Flip Cards */}
      <section className="py-20 bg-gradient-to-br from-teal-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why SerchBy?</h2>
            <p className="text-xl text-gray-600">Hover to discover our unique selling points</p>
          </div>
      ...
      {/* Offers in Reels Feature */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              🔥 "Offers in Reels" – Our Signature Feature
            </h2>
            <p className="text-xl text-gray-600">Instagram-like deal stories for local commerce</p>
          </div>
      ...
      <section id="how-it-works" className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How SerchBy Works</h2>
            <p className="text-xl text-gray-600">Get started in 3 simple steps</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "1", icon: Download, title: "Download SerchBy App", desc: "Available on iOS and Android" },
              { step: "2", icon: Store, title: "Browse Offers or Create Store", desc: "Explore deals or start selling" },
              { step: "3", icon: MessageCircle, title: "Chat, Order, or Book Instantly", desc: "Connect directly with businesses" }
            ].map((item, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-teal-600 rounded-full flex items-center justify-center mx-auto mb-4 transform hover:scale-110 transition-transform duration-300">
                    <item.icon className="w-10 h-10 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-teal-800 rounded-full flex items-center justify-center text-white font-bold">
                    {item.step}
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-teal-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-teal-700 transition-all duration-300 flex items-center justify-center">
                Get Started
