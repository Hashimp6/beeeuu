...
//       category: "PREMIUM",
//       time: "2.5 km",
//       service: "Mega Beauty Sale",
//       store: "Diana's Henna Studio",
//       rating: "4.2",
//       originalPrice: "₹100",
//       salePrice: "₹50",
//       discount: "50% OFF",
...
//       category: "PREMIUM",
//       time: "1.2 km",
//       service: "Super Delicious Food",
//       store: "Spice Garden Restaurant",
//       rating: "4.5",
//       originalPrice: "₹200",
//       salePrice: "₹120",
//       discount: "40% OFF",
...
//       description: "Find deals within 5km radius. No more missing out on neighborhood offers.",
//       color: "from-red-500 to-pink-500"
//     },
//     {
//       icon: Clock,
//       title: "Real-Time Updates",
//       description: "Live inventory, instant notifications. Know what's available right now.",
//       color: "from-blue-500 to-cyan-500"
//     },
//     {
//       icon: Zap,
//       title: "Lightning Fast Booking",
//       description: "Book services in under 30 seconds. Skip queues, save time.",
//       color: "from-yellow-500 to-orange-500"
//     },
//     {
//       icon: Shield,
//       title: "Verified Businesses",
//       description: "All partners are verified. Shop with confidence and security.",
//       color: "from-green-500 to-emerald-500"
//     },
//     {
//       icon: Users,
//       title: "Community Driven",
//       description: "Real reviews from real neighbors. Trust the local community.",
//       color: "from-purple-500 to-indigo-500"
//     },
//     {
//       icon: Sparkles,
//       title: "Exclusive Deals",
//       description: "SerchBy-only offers you won't find anywhere else online.",
...
//       step: "01",
//       title: "Open SerchBy",
//       description: "Launch the app and allow location access to see nearby offers",
//       icon: Search,
//       color: "bg-red-500"
//     },
//     {
...
//       description: "Swipe through offer stories like Instagram. Visual, quick, engaging",
//       icon: Camera,
//       color: "bg-blue-500"
//     },
//     {
...
//       description: "Tap to call, chat, or book. Direct connection with local businesses",
//       icon: MessageCircle,
//       color: "bg-green-500"
//     },
//     {
//       step: "04",
//       title: "Enjoy & Review",
//       description: "Get your service/product and help others with honest reviews",
//       icon: Star,
//       color: "bg-purple-500"
//     }
//   ];
...
//       <section className="pt-24 pb-20 bg-gradient-to-br from-teal-50 via-white to-blue-50 overflow-hidden">
...
//                 India's First Local Commerce Stories Platform
//               </div>
...
//                 Discover real-time offers from nearby shops through engaging stories. Book services, buy products, and support local businesses - all in one tap.
//               </p>
//             </div>
//           </div>
...
//                 <div className="bg-gray-900 rounded-[2.5rem] overflow-hidden h-[640px]">
//                   {/* Status Bar */}
...
//                     <div className="text-2xl font-bold text-teal-600">SerchBy</div>
...
//                   {/* Main Offer Card */}
//                   <div className={`bg-gradient-to-br ${offers[currentOffer].bgGradient} mx-4 my-4 rounded-2xl overflow-hidden shadow-lg relative`}>
//                     {/* Background Pattern */}
//                     <div className="absolute inset-0 opacity-10">
//                       <div className="absolute top-4 right-4 text-6xl opacity-50">{offers[currentOffer].image}</div>
//                       <div className="absolute bottom-4 left-4 text-4xl opacity-30">{offers[currentOffer].image}</div>
//                     </div>

//                     {/* Header */}
//                     <div className="bg-black/20 px-4 py-2 flex items-center justify-between relative z-10">
...
//                       <div className="flex items-center bg-black/20 rounded-lg p-2 mb-3">
//                         <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-2">
//                           <span className="text-xs">{offers[currentOffer].image}</span>
//                         </div>
//                         <div className="flex-1">
//                           <div className="text-white font-semibold text-sm">{offers[currentOffer].store}</div>
//                           <div className="flex items-center">
//                             <Star className="w-3 h-3 text-yellow-400 fill-current mr-1" />
//                             <span className="text-white/80 text-xs">{offers[currentOffer].rating}</span>
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
//                       <div className="text-6xl mb-3 filter drop-shadow-lg">{offers[currentOffer].image}</div>
//                       <h3 className="text-xl font-bold mb-2 text-shadow">{offers[currentOffer].service}</h3>
                      
//                       {/* Price Section */}
//                       <div className="bg-black/30 backdrop-blur-sm rounded-xl p-4 mb-4">
//                         <div className="flex items-center justify-center gap-3 mb-2">
//                           <span className="text-3xl font-bold text-white">{offers[currentOffer].salePrice}</span>
//                           <div className="text-right">
//                             <div className="text-xs text-white/60">was</div>
//                             <span className="text-lg line-through text-white/60">{offers[currentOffer].originalPrice}</span>
//                           </div>
//                         </div>
//                         <div className="bg-red-500 px-4 py-2 rounded-full text-sm font-bold inline-block animate-pulse">
//                           {offers[currentOffer].discount}
//                         </div>
//                       </div>
                      
//                       {/* Valid Till */}
//                       <div className="bg-teal-600/80 backdrop-blur-sm px-3 py-2 rounded-lg mb-4">
//                         <span className="text-sm font-medium">Valid till: {offers[currentOffer].validTill}</span>
//                       </div>
//                     </div>

//                     {/* View More Button */}
//                     <div className="px-4 pb-4 relative z-10">
//                       <button className="w-full bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg">
//                         View More →
//                       </button>
//                     </div>

//                     {/* Bottom Info */}
//                     <div className="px-4 pb-4 flex items-center justify-between text-xs text-white/80 relative z-10">
//                       <div className="flex items-center">
//                         <Heart className="w-3 h-3 mr-1 fill-current text-red-400" />
//                         <span>{offers[currentOffer].likes}</span>
//                       </div>
//                       <div className="flex items-center">
//                         <MapPin className="w-3 h-3 mr-1" />
//                         <span>{offers[currentOffer].location}</span>
//                       </div>
//                     </div>
//                   </div>
...
//                           index === currentOffer ? 'bg-teal-500 w-6' : 'bg-gray-300'
//                         }`}
//                       />
//                     ))}
//                   </div>
...
//                   {/* Bottom Navigation */}
//                   <div className="bg-white border-t flex items-center justify-around py-2 mt-auto">
...
//                       <span className="text-xs text-teal-600 mt-1">Offers</span>
//                     </div>
//                     <div className="flex flex-col items-center p-2">
//                       <div className="w-6 h-6 bg-gray-300 rounded"></div>
...
//               </div>
//               <div className="absolute -bottom-6 -left-6 w-10 h-10 bg-green-400 rounded-full flex items-center justify-center animate-pulse">
...
//               What You Can Do on SerchBy
//             </h2>
//             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
//               Discover amazing local offers, buy products instantly, and book appointments - all through engaging visual stories from your neighborhood businesses.
//             </p>
//           </div>
...
//                 <h3 className="text-2xl font-bold text-gray-900 mb-3">Find Nearest Offers</h3>
//                 <p className="text-gray-600 mb-6">Discover real-time deals from local businesses around you</p>
...
//                     </span>
//                   </div>
//                   <h4 className="font-bold text-gray-900 mb-1">Fried Chicken Sunday Deal</h4>
//                   <p className="text-sm text-gray-600 mb-2">Crispy Chicken Corner</p>
//                   <div className="flex items-center justify-between">
//                     <div className="flex items-center gap-2">
//                       <span className="text-sm line-through text-gray-500">₹200</span>
...
//                 <div className="mt-4 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-4 border-l-4 border-orange-500">
//                   <div className="flex items-center justify-between mb-2">
//                     <span className="text-2xl">🧅</span>
...
//                     </span>
//                   </div>
//                   <h4 className="font-bold text-gray-900 mb-1">3 KG Onion - ₹100 Only</h4>
//                   <p className="text-sm text-gray-600 mb-2">Fresh Valley Grocery</p>
//                   <div className="flex items-center justify-between">
//                     <span className="font-bold text-orange-600">Valid for 2 days</span>
//                     <span className="text-xs text-gray-500">0.8 km away</span>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                 <h3 className="text-2xl font-bold text-gray-900 mb-3">Shop Instantly</h3>
//                 <p className="text-gray-600 mb-6">Buy anything from local stores with one tap</p>
...
//                       </div>
//                       <div className="flex-1">
//                         <h4 className="font-bold text-gray-900">iPhone 15 Case</h4>
//                         <p className="text-sm text-gray-600">Tech Accessories Hub</p>
//                         <div className="flex items-center justify-between mt-1">
//                           <span className="font-bold text-teal-600">₹899</span>
...
//                       </div>
//                       <div className="flex-1">
//                         <h4 className="font-bold text-gray-900">Cotton T-Shirt</h4>
//                         <p className="text-sm text-gray-600">Style Zone Fashion</p>
//                         <div className="flex items-center justify-between mt-1">
//                           <span className="font-bold text-cyan-600">₹599</span>
...
//                 <h3 className="text-2xl font-bold text-gray-900 mb-3">Book Appointments</h3>
//                 <p className="text-gray-600 mb-6">Schedule services instantly with local professionals</p>
...
//                       </span>
//                     </div>
//                     <h4 className="font-bold text-gray-900 mb-1">Hair Coloring Service</h4>
//                     <p className="text-sm text-gray-600 mb-2">Glamour Beauty Salon</p>
//                     <div className="flex items-center justify-between">
//                       <span className="font-bold text-purple-600">₹1299</span>
//                       <span className="text-xs text-gray-500">Today 3 PM</span>
//                     </div>
//                   </div>
...
//                       </span>
//                     </div>
//                     <h4 className="font-bold text-gray-900 mb-1">Haircut + Facial - ₹599</h4>
//                     <p className="text-sm text-gray-600 mb-2">Men's Grooming Studio</p>
//                     <div className="flex items-center justify-between">
//                       <span className="font-bold text-indigo-600">Tuesday Only</span>
...
//             <button className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-teal-700 hover:to-cyan-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
//               Explore SerchBy Now
          ...
          <div className="lg:hidden absolute top-full left-0 w-full bg-white shadow-xl border-t border-teal-100 animate-slide-down">
            <div className="px-4 py-6 space-y-4">
              <div className="flex flex-col space-y-3 pt-4">
                ...
                <button   onClick={() => navigate("/home")} className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white px-8 py-3 rounded-xl text-base font-bold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                  Explore
                </button>
              </div>
            </div>
