...
// import ReturnRefundPolicy from './policies/ReturnPolicy';
  ...
  return (
    <div className="bg-white min-h-screen py-10 px-4 md:px-16 text-gray-800 font-sans">
      <div className="max-w-4xl mx-auto shadow-md rounded-2xl bg-white p-8 border border-gray-200">
        <h1 className="text-3xl font-bold text-center mb-8 text-violet-700">Privacy Policy</h1>

        <p className="text-center text-gray-500 mb-10">
          At Serchby, we are committed to safeguarding your privacy and protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and secure your data when you access or use our platform.
        </p>
        ...
        <div className="space-y-6">
          <Section number="1" title="Information We Collect">
            ...
            <ul className="list-disc pl-5 mt-2 text-sm text-gray-600">
              <li><strong>Personal Information:</strong> Name, email address, phone number, address, payment details, etc.</li>
              <li><strong>Account Information:</strong> Username, password, profile data, order history.</li>
              <li><strong>Usage Data:</strong> Device type, browser, IP address, access times, and browsing behavior.</li>
              <li><strong>Cookies and Tracking:</strong> We use cookies and similar technologies to enhance user experience and analyze platform performance.</li>
            </ul>
          </Section>
          ...
          <Section number="2" title="How We Use Your Information">
            ...
            <ul className="list-disc pl-5 mt-2 text-sm text-gray-600">
              ...
              <li>Provide and manage your account and orders</li>
              <li>Communicate updates, offers, or support responses</li>
              <li>Analyze user behavior and improve platform functionality</li>
          ...
          <Section number="3" title="Sharing of Information">
            ...
            <ul className="list-disc pl-5 mt-2 text-sm text-gray-600">
              <li>Sellers to fulfill your orders and respond to queries</li>
              <li>Service Providers for payments, logistics, and analytics</li>
              <li>Law Enforcement or Government Authorities when required by law</li>
            </ul>
          </Section>

          <Section number="4" title="Data Security">
            We implement appropriate technical and organizational measures to protect your data from unauthorized access, disclosure, or loss. However, no system is 100% secure, and we encourage users to maintain strong account passwords.
          </Section>
          ...
          <Section number="5" title="Your Rights">
            ...
            <ul className="list-disc pl-5 mt-2 text-sm text-gray-600">
              ...
              <li>Request deletion of your account or data (subject to legal and business obligations)</li>
              <li>Opt out of marketing communications at any time</li>
            </ul>
            <p className="mt-2">To exercise any of these rights, contact us at <a href="mailto:hashimhusain313@gmail.com" className="text-violet-600">hashimhusain313@gmail.com</a>.</p>
          </Section>
          ...
          <Section number="7" title="Children’s Privacy">
            Serchby is not intended for children under the age of 13. We do not knowingly collect data from minors. If we become aware of such data, we will take appropriate steps to delete it.
          </Section>
