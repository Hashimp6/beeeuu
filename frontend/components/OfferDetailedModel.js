// Integration instructions for OffersReelsFeed.js:

/* 
1. Import the OfferDetailsModal component at the top of your OffersReelsFeed.js file:
   import OfferDetailsModal from './OfferDetailsModal';

2. Add state to manage modal visibility and selected offer in your OffersReelsFeed component:
   const [selectedOffer, setSelectedOffer] = useState(null);
   const [showModal, setShowModal] = useState(false);

3. Update your onMoreDetailsPress function:
...
4. Add these handler functions:
   ...
   const handleGetDirections = () => {
     // Handle directions action if needed
     console.log('Getting directions to:', selectedOffer?.place);
   };

5. Add the modal component to your return JSX (after ScrollView):
   <OfferDetailsModal
     visible={showModal}
     offer={selectedOffer}
     ...
     userLocation={userLocation} // Pass user's location for distance calculation
   />

6. Update your OffersReelsFeed component call to pass the handler:
   <OffersReelsFeed
     offers={offers}
